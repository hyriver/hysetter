...
Report bugs at https://github.com/hyriver/hysetter/issues.
...
The best way to send feedback is to file an issue at https://github.com/hyriver/hysetter/issues.
...
Ready to contribute? Here's how to set up hysetter for local development.

1. Fork the AsyncRetriever repo through the GitHub website.
2. Clone your fork locally and add the main ``hysetter`` as the upstream remote:

.. code-block:: console

    $ git clone git@github.com:your_name_here/hysetter.git
    $ git remote add upstream git@github.com:hyriver/hysetter.git
